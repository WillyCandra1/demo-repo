...
// Role 1 Menu - Core System and Product Management
void role1Menu() {
    int choice;
    do {
        clearScreen();
...
// Role 2 Menu - Inventory and Stock Management
void role2Menu() {
    int choice;
    do {
        clearScreen();
...
// Role 3 Menu - Category and Supplier Management
void role3Menu() {
    int choice;
    do {
        clearScreen();
...
// Role 4 Menu - User and Transaction Management
void role4Menu() {
    int choice;
    do {
        clearScreen();
